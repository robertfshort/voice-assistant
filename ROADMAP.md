...
The next roadmap step is the first feature from the **## Future feature notes** section, likely one of play session transcription, GM-controlled character TTS, or in-app spell check.
